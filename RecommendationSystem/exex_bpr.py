...
if __name__ == "__main__":
    # data
    trainMatrix, testRatings = load_data('yelp.rating.txt')
    ...
    bpr = MFbpr(trainMatrix, testRatings, topK, factors, maxIter, lr, adaptive, reg, init_mean, init_stdev,
                showProgress, showLoss)
    bpr.buildModel()
